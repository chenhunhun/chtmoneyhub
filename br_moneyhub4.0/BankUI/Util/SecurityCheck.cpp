...
{	
	...
	ProcessHelp = 1;
	CRecordProgram::GetInstance()->RecordCommonInfo(MY_PRO_NAME, MY_COMMON_PROCESS, CRecordProgram::GetInstance()->GetRecordInfo(L"Begin SysModuleVerify:SysModuleVerify Files Num:%d", m_files.size()));
