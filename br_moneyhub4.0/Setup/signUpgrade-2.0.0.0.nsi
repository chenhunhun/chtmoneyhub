...
!else 
    ...
    !define MUI_PAGE_CUSTOMFUNCTION_PRE WelcomePageSetup
	!define MUI_PAGE_CUSTOMFUNCTION_SHOW WelcomePageText
	...
	!define MUI_PAGE_CUSTOMFUNCTION_PRE FinishPageSetup
	...
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Type" "Text"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Flags" "NOTABSTOP|MULTILINE|VSCROLL|WANTRETURN|READONLY"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Left" "120"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Right" "320"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" "40"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" "182"
	FunctionEnd
	...
	GetDlgItem $0 $0 1202
	SetCtlColors $0 "000000" "F5FBFF"
	SendMessage $0 ${WM_SETTEXT} 0 "STR:$1"
	FunctionEnd

	Function FinishPageSetup
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Type" "LABEL"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Text" "财金汇升级已经完成！"
	!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Flags" "NOTABSTOP|READONLY"
	FunctionEnd
	...
	completed4:
		...
		Call verchange
		ExecWait '"$INSTDIR\MoneyHub.exe" -verchange' $1
		${If} $1 != 0
		Call DoUninstall
	...
	SectionEnd
	    ...
	    Function verchange
		!insertmacro MUI_HEADER_TEXT "正在升级" "正在升级本地数据库，这可能需要较长时间，请稍候..."
		DetailPrint "正在升级本地数据库，这可能需要较长时间，请稍候..."
		FunctionEnd
