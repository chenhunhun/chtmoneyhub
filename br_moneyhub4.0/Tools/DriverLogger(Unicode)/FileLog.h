...
void LogInitialize(ULONG loglevel,WCHAR* logfilename = L"\\Device\\HarddiskVolume1\\MoneyHubDriver.log",LONGLONG filesize = 20 * 1024 * 1024,USHORT strategy = 1);
/**
* 写日志函数
* @param iLevel:ULONG,要写入日志信息的等级，请参考LogConst.h文件内等级。
* @param format:NTSTRSAFE_PWSTR*,输入信息的格式，此格式参考printf。
