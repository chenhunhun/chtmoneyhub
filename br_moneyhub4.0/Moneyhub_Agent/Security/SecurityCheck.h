...
protected:
	...
	static DWORD WINAPI _threadNetSysVerify(LPVOID lp);//有网微软检测线程

	static DWORD WINAPI _threadSysVerify(LPVOID lp);//无网微软检测线程

	static DWORD WINAPI _threadCloudVerify(LPVOID lp);//云查杀线程
