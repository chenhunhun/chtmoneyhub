...
{
public:
	CSynchroDlg(/*ThreadDataStruct* pTds*/);
	~CSynchroDlg();
...
public:
	...
	void   NextPData (int icase);
	void   ForData (std::string strfor ,int icase,int ifor);
	void   ForAddData (std::string strfor ,int icase,int ifor);
