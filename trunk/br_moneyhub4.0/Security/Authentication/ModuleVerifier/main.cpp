...
bool ModuleVerifier::IsModuleVerified(const CStringW& filepath,bool bRevokeCheck)
{
	if (g_pSysModVerify->IsModuleVerified(filepath, bRevokeCheck))
		return true;
...
bool ModuleVerifier::IsSysModuleVerified(const CStringW& filepath, bool bRevokeCheck)
{
	if (g_pSysModVerify->IsModuleVerified(filepath, bRevokeCheck))
		return true;
