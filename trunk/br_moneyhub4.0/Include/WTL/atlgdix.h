...
//#include "f:\project\web\browser\src\SogouBrowser\MainUIFrame\UIControl\Utility.h"
...
public:
   ...
   CMemDC(HDC hDC, const LPRECT pRect = NULL)
   {
      ATLASSERT(hDC!=NULL);
      m_dc = hDC;
...
class CLayeredMemDC : public CDC
{
...
public:
	...
	void CreateMemDC(int iWidth, int iHeight)
	{
 		...
 		m_bmpBuffer.CreateDIBSection(NULL, (BITMAPINFO *) &bmih, 0, (VOID**)&m_pBits, NULL, 0);
 		SelectBitmap(m_bmpBuffer);
	}
...
class CSizableMemDC : public CDC
{
