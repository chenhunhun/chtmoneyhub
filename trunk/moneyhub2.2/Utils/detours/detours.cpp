...
LONG Detours::DetourUpdateThread(HANDLE hThread)
{
	return ::DetourUpdateThread(hThread);
}
LONG Detours::DetourAttach(PVOID *ppPointer, PVOID pDetour)
{
	return ::DetourAttach(ppPointer, pDetour);
}
LONG Detours::DetourDetach(PVOID *ppPointer, PVOID pDetour)
{
