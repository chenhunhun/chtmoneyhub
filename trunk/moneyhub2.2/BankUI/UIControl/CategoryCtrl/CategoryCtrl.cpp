...
CCategoryItem* CTuotuoCategoryCtrl::FindOrCreateItem(LPCTSTR lpszURL, CTabItem *pItem)
{
	const CWebsiteData *pData;

	if (CListManager::IsHomePage(lpszURL))
	{
...
#endif
		pData = CURLList::GetInstance()->GetData(NULL, lpszURL);
	}
...
CCategoryItem* CTuotuoCategoryCtrl::FindExistItem(LPCTSTR lpszURL)
{
	const CWebsiteData *pData;
