...
public:
    ...
    static CDetourImage *         IsValid(PDETOUR_BINARY pBinary);
...
public:
    CImageThunks(CDetourImage *pImage, DWORD nThunksMax, DWORD *pnAddr)
    {
        m_pImage = pImage;
        m_nThunks = 0;
...
public:
    CImageChars(CDetourImage *pImage, DWORD nCharsMax, DWORD *pnAddr)
    {
        m_pImage = pImage;
        m_nChars = 0;
...
//////////////////////////////////////////////////////////////////////////////
//
CDetourImage * CDetourImage::IsValid(PDETOUR_BINARY pBinary)
{
    if (pBinary) {
        CDetourImage *pImage = (CDetourImage *)pBinary;
...
//////////////////////////////////////////////////////////////////////////////
//
PBYTE CDetourImage::DataEnum(GUID *pGuid, DWORD *pcbData, DWORD *pnIterator)
{
...
PBYTE CDetourImage::DataFind(REFGUID rguid, DWORD *pcbData)
{
    if (m_pImageData == NULL) {
        return NULL;
    }
...
PBYTE CDetourImage::DataSet(REFGUID rguid, PBYTE pbData, DWORD cbData)
{
    if (m_pImageData == NULL) {
        return NULL;
    }
...
BOOL CDetourImage::DataDelete(REFGUID rguid)
{
    if (m_pImageData == NULL) {
        return FALSE;
    }
...
//////////////////////////////////////////////////////////////////////////////
//
BOOL CDetourImage::SizeOutputBuffer(DWORD cbData)
{
...
PBYTE CDetourImage::AllocateOutput(DWORD cbData, DWORD *pnVirtAddr)
{
...
//////////////////////////////////////////////////////////////////////////////
//
DWORD CDetourImage::FileAlign(DWORD nAddr)
{
    return Align(nAddr, m_NtHeader.OptionalHeader.FileAlignment);
}

DWORD CDetourImage::SectionAlign(DWORD nAddr)
{
...
//////////////////////////////////////////////////////////////////////////////
//
PVOID CDetourImage::RvaToVa(ULONG_PTR nRva)
{
    if (nRva == 0) {
        return NULL;
    }
...
DWORD CDetourImage::RvaToFileOffset(DWORD nRva)
{
    DWORD n;
...
//////////////////////////////////////////////////////////////////////////////
//
BOOL CDetourImage::WriteFile(HANDLE hFile, LPCVOID lpBuffer, DWORD nNumberOfBytesToWrite,
                       LPDWORD lpNumberOfBytesWritten)
{
...
BOOL CDetourImage::CopyFileData(HANDLE hFile, DWORD nOldPos, DWORD cbData)
{
    DWORD cbDone = 0;
    return WriteFile(hFile, m_pMap + nOldPos, cbData, &cbDone);
}

BOOL CDetourImage::ZeroFileData(HANDLE hFile, DWORD cbData)
{
...
BOOL CDetourImage::AlignFileData(HANDLE hFile)
{
...
BOOL CDetourImage::Read(HANDLE hFile)
{
    DWORD n;
    PBYTE pbData = NULL;
    DWORD cbData = 0;
...
BOOL CDetourImage::CheckImportsNeeded(DWORD *pnTables, DWORD *pnThunks, DWORD *pnChars)
{
    DWORD nTables = 0;
    DWORD nThunks = 0;
    DWORD nChars = 0;
...
//////////////////////////////////////////////////////////////////////////////
//
CImageImportFile * CDetourImage::NewByway(__in_z PCHAR pszName)
{
    CImageImportFile *pImportFile = new CImageImportFile;
    if (pImportFile == NULL) {
        SetLastError(ERROR_OUTOFMEMORY);
...
BOOL CDetourImage::EditImports(PVOID pContext,
                         PF_DETOUR_BINARY_BYWAY_CALLBACK pfBywayCallback,
                         PF_DETOUR_BINARY_FILE_CALLBACK pfFileCallback,
                         PF_DETOUR_BINARY_SYMBOL_CALLBACK pfSymbolCallback,
                         PF_DETOUR_BINARY_COMMIT_CALLBACK pfCommitCallback)
...
BOOL CDetourImage::Write(HANDLE hFile)
{
    DWORD cbDone;
...
{
    Detour::CDetourImage *pImage = new Detour::CDetourImage;
    if (pImage == NULL) {
        SetLastError(ERROR_OUTOFMEMORY);
        return FALSE;
    }
...
{
    Detour::CDetourImage *pImage = Detour::CDetourImage::IsValid(pdi);
    if (pImage == NULL) {
        return FALSE;
    }
