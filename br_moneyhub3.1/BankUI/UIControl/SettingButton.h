...
class CSettingButton: public CTuoToolBarCtrl<CSettingButton>, public CFSMUtil
{
public:
	CSettingButton(FrameStorageStruct *pFS);
...
protected:
	BEGIN_MSG_MAP_EX(CSettingButton)
		CHAIN_MSG_MAP(CTuoToolBarCtrl<CSettingButton>)
