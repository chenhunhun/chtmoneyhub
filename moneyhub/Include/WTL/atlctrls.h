...
// Operations
	...
	int GetNextSelectedItem(int iPos) const
	{ 
		ATLASSERT(::IsWindow(m_hWnd)); 
		return GetNextItem(iPos, LVIS_SELECTED); 
	}
...
// Attributes
	...
	BOOL GetRectByIndex(int nIndex, LPRECT lpRect) const
	{
		ATLASSERT(::IsWindow(m_hWnd));
	...
	BOOL GetRectByCommandID(int nID, LPRECT lpRect) const
	{
		ATLASSERT(::IsWindow(m_hWnd));
