...
private:
	...
	BEGIN_MSG_MAP_EX(CChildFrame)
		...
		MESSAGE_HANDLER(WM_ITEM_ASK_SAVE_FAV, OnAskSaveFav)
		MESSAGE_HANDLER(WM_ITEM_TEST_SAVE_FAV, OnTestSaveFav)
	...
	LRESULT OnTabClose(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL &bHandled);
	LRESULT OnAskSaveFav(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL &bHandled);
	LRESULT OnTestSaveFav(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL &bHandled);
private:
