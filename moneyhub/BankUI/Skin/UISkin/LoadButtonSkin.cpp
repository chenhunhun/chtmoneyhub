...
CLoadButtonSkin::CLoadButtonSkin(CSkinManager *pSkin)
{
	pSkin->RegisterFileName(_T("Load_button"), m_bitmap);
}

void CLoadButtonSkin::Refresh()
{
	m_bitmap.LoadFromFile();
	//m_bitmapMask.LoadFromFile();
}

void CLoadButtonSkin::DrawButton(CDCHandle dc, const RECT &rc, UINT uButtonStatus) const
{
