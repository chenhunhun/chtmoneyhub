...
HRESULT CWebBrowserCore::CreateIEServer(HWND hAxWnd, IOleClientSite *pClientSite)
{
	...
	if (FAILED(hRes))
	{
		CRecordProgram::GetInstance()->FeedbackError(MY_PRO_NAME, MY_THREAD_IE_STATE, CRecordProgram::GetInstance()->GetRecordInfo(L"CreateIEServer:CoGetClassObject error:0x%08x",hRes));
		return hRes;
	}
	...
	if (FAILED(hRes))
	{
		CRecordProgram::GetInstance()->FeedbackError(MY_PRO_NAME, MY_THREAD_IE_STATE, CRecordProgram::GetInstance()->GetRecordInfo(L"CreateIEServer:spClassFactory->CreateInstance error:0x%08x",hRes));
		return hRes;
	}
	...
	if (FAILED(hRes))
	{
		CRecordProgram::GetInstance()->FeedbackError(MY_PRO_NAME, MY_THREAD_IE_STATE, CRecordProgram::GetInstance()->GetRecordInfo(L"CreateIEServer:m_pOleObject->SetClientSite error:0x%08x",hRes));
		return hRes;
	}
	...
	if (FAILED(hRes))
	{
		CRecordProgram::GetInstance()->FeedbackError(MY_PRO_NAME, MY_THREAD_IE_STATE, CRecordProgram::GetInstance()->GetRecordInfo(L"CreateIEServer:OleSetContainedObject error:0x%08x",hRes));
	...
	if (FAILED(hRes))
	{
		CRecordProgram::GetInstance()->FeedbackError(MY_PRO_NAME, MY_THREAD_IE_STATE, CRecordProgram::GetInstance()->GetRecordInfo(L"CreateIEServer:DoVerb error:0x%08x",hRes));
		m_pOleObject->Release();
		m_pOleObject = NULL;
	...
	if (FAILED(hRes))
	{
		CRecordProgram::GetInstance()->FeedbackError(MY_PRO_NAME, MY_THREAD_IE_STATE, CRecordProgram::GetInstance()->GetRecordInfo(L"CreateIEServer:QueryInterface1 error:0x%08x",hRes));
		m_pOleObject->Release();
		m_pOleObject = NULL;
	...
	if (FAILED(hRes))
	{
		CRecordProgram::GetInstance()->FeedbackError(MY_PRO_NAME, MY_THREAD_IE_STATE, CRecordProgram::GetInstance()->GetRecordInfo(L"CreateIEServer:QueryInterface2 error:0x%08x",hRes));
		m_pOleObject->Release();
		m_pOleObject = NULL;
